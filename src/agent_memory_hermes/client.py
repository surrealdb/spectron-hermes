...
def agent_memory_installed() -> bool:
    ...
    try:
        ...
        return importlib.util.find_spec("surrealdb.memory") is not None
    except Exception:
        return False
...
def agent_memory_errors() -> Tuple[type, ...]:
    ...
    """
    try:
        from surrealdb.memory import MemoryServiceError  # type: ignore
...
def is_auth_error(exc: BaseException) -> bool:
    ...
    try:
        ...
        return isinstance(exc, (MemoryAuthError, MemoryScopeError))
    except Exception:
        return False
...
def build_client(config: AgentMemoryConfig) -> Any:
    ...
    """
    from surrealdb.memory import Memory  # type: ignore
