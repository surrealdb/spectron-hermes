...
| [`live_session.py`](live_session.py) | The same flow against a **real Spectron instance** — a genuine remember → recall round-trip. | `surrealdb>=3.0.0a1` + Spectron credentials. |
