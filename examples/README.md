...
| [`live_session.py`](live_session.py) | The same flow against a **real Spectron instance** — a genuine remember → recall round-trip. | `surrealdb[spectron]` + Spectron credentials. |
...
```bash
pip install -e . "surrealdb[spectron]"
